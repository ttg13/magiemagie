...
<div class="floating-box-main">
    <a  class="button" href="<c:url value="/Passer le tour"/>"> Lancer un sort</a><br><br><br><br>
<a  class="button" href="<c:url value="/Passer le tour"/>"> Passer le tour</a><br><br><br><br>
</div>
